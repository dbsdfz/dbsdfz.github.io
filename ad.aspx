...
<div style="background-color: black;box-shadow: 1px 3px 12px gray;">
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 mb-0">
      ...
      <ul class="nav nav-pills">
        <li class="nav-item"><a href="/"  class="btn btn-sm"> 首页 </a></li>
          <li class="nav-item"><a href="#"  class="btn btn-sm  " data-bs-toggle="dropdown">网站简介</a>
 <div class="dropdown-menu" >
   ...
   <a href="about.aspx" class="dropdown-item" >关于本站</a>
         ...
         <li class="nav-item"><a href="#"  class="btn  btn-sm  xuanzhong" data-bs-toggle="dropdown">广告投放</a>
 <div class="dropdown-menu" >
...
<img src="https://img1.imgtp.com/2022/06/08/JPVzOn9p.png" width="100%" >
</div>
  ...
  <div style="margin-left:8%;margin-right:8%;">
    <br>
  <div class="card ">
    <div class="card-header text-dark  bg-white"><h6>学习宝广告（有偿竞价广告）</h6></div>
    <div class="card-body "> 
<p style="color:grey;font-size:14px;" >暂无内容
  ...
  <div class="card ">
    <div class="card-header text-dark  bg-white"><h6>公众号广告（有偿竞价广告）</h6></div>
    <div class="card-body "> 
<p style="color:grey;font-size:14px;" >暂无内容
</p>
