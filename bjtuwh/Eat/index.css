...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 60) return '等级：LEVEL 1';
    if (score <= 89) return '等级：LEVEL 2';
    if (score <= 109) return '等级：LEVEL 3';
    if (score <= 118) return '等级：LEVEL 4';
    if (score <= 125) return '等级：LEVEL 5';
    if (score <= 135) return '等级：LEVEL 6';
    if (score <= 145) return '等级：LEVEL 7';
    if (score <= 156) return '等级：LEVEL 8';
    if (score <= 173) return '等级：LEVEL 9';
    if (score <= 190) return '等级：LEVEL 10';
    return '等级：LEVEL SSS';
}
